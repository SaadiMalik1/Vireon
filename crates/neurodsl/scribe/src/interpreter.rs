        ...
        while ip < bytecode.len() {
            ...
            match opcode {
                0x01 => {
                    ...
                    if bytecode[ip + 1] > 100 {
                        return Err(ScribeError::SecurityViolation("Amplitude > 100".into()));
                    }
                    ip += 2;
                }
                0x02 => {
                    ...
                    if freq > 1000 {
                        return Err(ScribeError::SecurityViolation("Frequency > 1000".into()));
                    }
                    ip += 3;
                }
                0x03 => {
            ...
            match opcode {
                ...
                0x05 => {
                    ...
                    if !eeg_data.is_empty() {
                        ...
                        let normalized =
                            ((val.clamp(-1000.0, 1000.0) + 1000.0) * (255.0 / 2000.0)) as u8;
