...
class Coordinator:
    ...
    def setup(self):
        ...
        if self.config.attacks.scenario_steps:
            from vireon.runtime.attack import AttackScenario, AttackStep
            steps = []
    ...
    def simulate_firmware_update(self, payload: bytes) -> bool:
        ...
        if self.emulator:
            ...
            # ZTA Pre-Check
            if self.zta_engine:
                from vireon.runtime.zta import AuthorizationDecision
    ...
    def _build_trust_context(self):
        from vireon.runtime.zta import TrustContext
